...
class SlipsControllerTest < ActionController::TestCase
  ...
  test "should create slip" do
    assert_difference('Slip.count') do
      post :create, slip: { amount: @slip.amount, slip_dtl_id: @slip.slip_dtl_id, user_id: @slip.user_id }
    end
  ...
  test "should update slip" do
    patch :update, id: @slip, slip: { amount: @slip.amount, slip_dtl_id: @slip.slip_dtl_id, user_id: @slip.user_id }
    assert_redirected_to slip_path(assigns(:slip))
  end
